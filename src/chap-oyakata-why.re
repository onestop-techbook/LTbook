...
//image[survey][積み基板の有無に関するアンケート]


周知不足で12票だけですが、そのうち11票（92%！）が「積み基板がある」という圧倒的な多数。別に実施したSlack内でのアンケートでも、8割の人が積み基板があるという回答でした。日本人の1億1千万人が積み基板を持っているということですね！


@<strong>{積み基板}とは、Arduinoをはじめとした小型基板、マイコンボードをとりあえず購入はするけれど、大して使うこともなく積んでいる状態と定義します。作りたいものがあるようないような、あるいは作りたいものはあったけれど飽きたり挫折したりして手が止まって放置状態になっている様と考えてください。
...
マイコン@<fn>{micon}使って何か作ろうと思いつきますか？あったら便利かも、と思うような小規模なデバイスを考えてみてください。何か思いつきますか？

//footnote[micon][マイコンと書きましたが、特にデバイスを指定するわけではなく、ArduinoでもRasPiでもmBedでも、その他でも構いません。入出力があって、プログラミングできる小型の基板やデバイスを総称するくらいのつもりで考えてください。]
