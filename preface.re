...
本書は、ITエンジニア向けコミュニティ『エンジニアの登壇を応援する会』が2023年9月に開催したイベント「LTのコツ大披露会」の発表をもとに、登壇者の発表の再構成、およびコミュニティに関わる皆さんの知見を追加して作成しました。
...
定期的に勉強会を開催していますので、ぜひ都合があうときに足を運んでみてください。
...
今回は私たちの勉強会でもよくテーマにする「LT」について、先輩登壇者たちが普段気をつけていることをたくさんアウトプットしています。
